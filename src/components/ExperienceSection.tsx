    ...
    <div className="flex flex-col md:flex-row gap-8 p-16 items-center justify-between align-middle">
      <Card className="bg-[#1B1B22] text-white p-8 rounded-3xl shadow-lg shadow-black md:w-96 border-none relative" >
        ...
        >
          ...
          <p className="text-gray-300 text-sm">
            ...
            comprehensive web development services, helping businesses transform
            their digital presence with innovative technology solutions.
          </p>
          <button className="bg-white hover:bg-green-600 text-black px-6 py-3 rounded-full text-sm font-semibold transition-colors">
           Enquiry Now
          </button>
        </motion.div>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24 items-center">
        ...
        >
          ...
          <p className="text-gray-300 text-xl">Happy Customer</p>
        </motion.div>
      </div>
    </div>
  );
