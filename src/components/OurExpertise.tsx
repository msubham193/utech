        ...
        <div className="flex justify-center items-center gap-4 py-4 px-8 w-full ">
          {getVisibleWebsites().map((site, index) => {
            ...
            return (
              ...
              >
                <CardContainer>
                  <CardBody className="bg-[#1B1B22] shadow-md shadow-black relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
                    <CardItem
                      translateZ="50"
