...
function UxBanner() {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-gray-900 to-gray-800 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          {/* Left side - UX Phone visual with images */}
          <div className="relative">
            <div className="text-6xl font-bold text-cyan-400 mb-2">UX</div>
            <div className="text-xl text-cyan-400 uppercase tracking-wider mb-6">
            ...
            <div className="relative h-96 flex items-center justify-center">
              ...
              {/* Glow effect */}
              <div className="absolute inset-0 bg-cyan-500/20 blur-3xl rounded-full z-0"></div>
            </div>
          </div>
          
          {/* Right side - Technical Tools auto slider */}
          <div className="relative">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl shadow-2xl overflow-hidden border border-cyan-400/20">
              ...
              <div className="flex justify-center p-3 bg-gradient-to-r from-cyan-500/10 to-cyan-400/20">
        ...
        <div className="mt-16 md:mt-24">
          <h2 className="text-2xl font-bold text-center text-cyan-400 mb-10">Our Partner Ecosystem</h2>
              ...
              {partnerData.map((partner, index) => (
                ...
                >
                  <div className="flex justify-center items-center px-4">
                    <div className="text-center transition-all duration-300 hover:text-cyan-400 hover:scale-105">
              ...
              {partnerData.map((_, index) => (
                <div
                  ...
                  className={`w-2 h-2 mx-2 rounded-full transition-all duration-300 ${
                    currentPartnerSlide === index ? 'bg-cyan-400 w-4' : 'bg-gray-600'
                  }`}
                />
              ))}
            </div>
